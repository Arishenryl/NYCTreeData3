...
#To answer specific questions end-users may have about the NYC tree data by utilizing several original functions to pull and organize the necessary data from the CSV.
#date May 14th 2023
